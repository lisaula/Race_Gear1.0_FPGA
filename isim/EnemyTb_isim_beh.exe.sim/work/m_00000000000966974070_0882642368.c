...
static int ng1[] = {0, 0};
static int ng2[] = {601, 0};
static int ng3[] = {1, 0};
static int ng4[] = {620, 0};
static int ng5[] = {610, 0};
...
LAB16:    xsi_set_current_line(31, ng0);
    ...
    t6 = *((char **)t5);
    memset(t4, 0, 8);
    xsi_vlog_unsigned_add(t4, 32, t3, 10, t6, 10);
    t12 = ((char*)((ng2)));
    memset(t28, 0, 8);
    t13 = (t4 + 4);
...
LAB22:    if (*((unsigned int *)t4) < *((unsigned int *)t12))
        goto LAB20;
...
LAB26:    xsi_set_current_line(33, ng0);
    ...
    t31 = *((char **)t30);
    memset(t32, 0, 8);
    xsi_vlog_unsigned_add(t32, 10, t29, 10, t31, 10);
    t33 = (t0 + 1748);
...
{
	static char *pe[] = {(void *)Cont_16_0,(void *)Always_23_1,(void *)Always_48_2,(void *)Initial_70_3};
	xsi_register_didat("work_m_00000000000966974070_0882642368", "isim/EnemyTb_isim_beh.exe.sim/work/m_00000000000966974070_0882642368.didat");
